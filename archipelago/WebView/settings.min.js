...
class tabs_controller_default extends BridgeComponent {
...
// controllers/fonts_controller.js
class fonts_controller_default extends BridgeComponent {
...
class radio_controller_default extends BridgeComponent {
...
class select_controller_default extends BridgeComponent {
...
class checkbox_controller_default extends BridgeComponent {
...
class text_controller_default extends BridgeComponent {
...
var isStringIndex = function(object, key) {
...
// controllers/color_controller.js
class color_controller_default extends BridgeComponent {
  static component = "color";
  connect() {
    super.connect();
    this.send("connect", {}, ({ data }) => {
      this.currentColor = import_color.default(getProperty(data, this.element.name));
      this.setValue();
    });
  }
  setValue() {
  ...
  changed(event) {
    let color = import_color.default(event.target.value);
...
var format_keybinding_default = (accelerator) => (accelerator || "").split("-").map((key) => MODIFIERS[key.toLowerCase()] || key).join("+");

// controllers/keybindings_controller.js
class keybindings_controller_default extends BridgeComponent {
  ...
  setValue(profile) {
    ...
    const active = [...document.querySelectorAll('[data-controller="keybinding"]')].findIndex((item) => item.classList.contains("active"));
    article.innerHTML = "";
    profile.keybindings.forEach(({ keystroke, command }, i) => {
      article.insertAdjacentHTML("beforeend", `<div data-controller='keybinding' data-action='click->keybinding#select dblclick->keybinding#edit' data-keybinding-keystroke-value=${keystroke} data-keybinding-command-value=${command} data-keybinding-index-value=${i}>
        <div class='w-60p'>${format_keybinding_default(keystroke) || ""}</div>
        <div>${command}</div>
      </div>`);
    });
...
// controllers/keybinding_controller.js
class keybinding_controller_default extends Controller {
      ...
      <dialog data-controller='modal keybinding-capturer' data-action="click@document->keybinding-capturer#exit close->modal#close" data-keybinding-capturer-index-value=${this.indexValue}>
        <div class='flex flex-col h-full w-full'>
          <div class='flex-1 flex flex-col w-full align-center gap-10 mt-15'>
            <div id='key-recorder' class='w-60p' value='${this.keystrokeValue}' data-keybinding-capturer-target='keystroke' data-action='click->keybinding-capturer#startCapture keydown@document->keybinding-capturer#capture keyup@document->keybinding-capturer#stop'>${format_keybinding_default(this.keystrokeValue) || "Click to set"}</div>
...
var MODIFIERS2 = new Set(["ctrl", "alt", "shift", "cmd"]);
...
// controllers/keybinding_capturer_controller.js
class keybinding_capturer_controller_default extends BridgeComponent {
  ...
  capture(event) {
    if (this.recording) {
      event.preventDefault();
      event.stopPropagation();
      const key = keystroke_for_keyboard_event_default(event);
      if (this.newKeystroke !== key) {
        this.newKeystroke = key;
        this.keystrokeTarget.setAttribute("value", key);
        this.keystrokeTarget.innerHTML = format_keybinding_default(key);
      }
    }
  }
}

// controllers/keybinding_actions_controller.js
class keybinding_actions_controller_default extends BridgeComponent {
  static component = "keybinding-actions";
  connect() {
    super.connect();
  }
  create() {
    const capturer = new keybinding_controller_default;
...
// controllers/profiles_controller.js
class profiles_controller_default extends BridgeComponent {
  ...
  setValue(config) {
    ...
    const active = [...document.querySelectorAll('[data-controller="profile"]')].findIndex((item) => item.dataset.profileIdValue == config.activeProfileId);
...
class profile_controller_default extends BridgeComponent {
...
// controllers/profile_capturer_controller.js
class profile_capturer_controller_default extends BridgeComponent {
...
// controllers/profile_actions_controller.js
class profile_actions_controller_default extends BridgeComponent {
  ...
  create() {
    this.send("create", {});
    setTimeout(() => {
      document.querySelector("#profiles article > div.active").dispatchEvent(new MouseEvent("dblclick"));
    }, 30);
  }
  destroy() {
...
// settings.js
var withOverriddenSend = function(BaseClass) {
...
application.register("tabs", withOverriddenSend(tabs_controller_default));
application.register("fonts", withOverriddenSend(fonts_controller_default));
application.register("radio", withOverriddenSend(radio_controller_default));
application.register("select", withOverriddenSend(select_controller_default));
application.register("checkbox", withOverriddenSend(checkbox_controller_default));
application.register("text", withOverriddenSend(text_controller_default));
application.register("color", withOverriddenSend(color_controller_default));
application.register("modal", modal_controller_default);
application.register("keybindings", withOverriddenSend(keybindings_controller_default));
application.register("keybinding", keybinding_controller_default);
application.register("keybinding-capturer", withOverriddenSend(keybinding_capturer_controller_default));
application.register("keybinding-actions", withOverriddenSend(keybinding_actions_controller_default));
application.register("profiles", withOverriddenSend(profiles_controller_default));
application.register("profile", withOverriddenSend(profile_controller_default));
application.register("profile-capturer", withOverriddenSend(profile_capturer_controller_default));
application.register("profile-actions", withOverriddenSend(profile_actions_controller_default));
